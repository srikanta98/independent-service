    ...
    return (
        <div className='font'>
            <div className=" my-5 font">
                <h1 className='service'>Get in touch with me</h1>
                <footer
                    className="text-center text-lg-start text-dark bg"

                >

                    <section
                        className="d-flex justify-content-between p-4 text-white sec2"
                        ...
                        <div className="container text-center text-md-start mt-5">
                            ...
                            <div className="row mt-3">
                                ...
                                <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                                    ...
                                    />
                                    <p>
                                        <a href="#!" className="text-dark font">Bangladesh</a>
                                    </p>
                                    <p>
                                        <a href="#!" className="text-dark font">Srilanka</a>
                                    </p>
                                    <p>
                                        <a href="#!" className="text-dark font">India</a>
                                    </p>
                                    <p>
                                        <a href="#!" className="text-dark font">Pakistan</a>
                                    </p>
                                </div>
